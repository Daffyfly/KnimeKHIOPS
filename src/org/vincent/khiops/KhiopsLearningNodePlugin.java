 ...
 * @author 
 */
public class KhiopsLearningNodePlugin extends Plugin {
    // The shared instance.
    private static KhiopsLearningNodePlugin plugin;

    /**
     * The constructor.
     */
    public KhiopsLearningNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static KhiopsLearningNodePlugin getDefault() {
        return plugin;
    }
